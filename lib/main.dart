                        ...
                        if (viewmodel.isRunning) {
                          return Row(
                            children: <Widget>[
                              FlatButton(
                                onPressed: (){
                                  Provider.of<StopWatchViewModel>(context, listen: false).lap();
                                },
                              ...
                              FlatButton(
                                onPressed: (){
                                  Provider.of<StopWatchViewModel>(context, listen: false).pause();
                                },
                          ...
                          return Row(
                            children: <Widget>[
                              FlatButton(
                                onPressed: (){
                                  Provider.of<StopWatchViewModel>(context, listen: false).reset();
                                },
                                shape: CircleBorder(side: BorderSide(color: Colors.grey)),
                                padding: EdgeInsets.all(25),
                              ...
                              FlatButton(
                                onPressed: (){
                                  Provider.of<StopWatchViewModel>(context, listen: false).start();
                                },
                                shape: CircleBorder(side: BorderSide(color: Color.fromRGBO(28, 150, 30, 1))),
                                padding: EdgeInsets.all(25),
                                child: Text(
                                  'Start',
                                  style: TextStyle(color: Colors.white),
                          ...
                          return Padding(
                            ...
                            child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    ClokcDuratiion(viewmodel.laps()[idx]).digitalClockString(),
                                    style: TextStyle(
                                        fontSize: 18,
                                        fontFeatures: [FontFeature.tabularFigures()]
                                    ),
